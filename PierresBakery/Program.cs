...
namespace PierresBakery {
  ...
  public class Program
  {
    ...
    static void Main()
    {
      ...
      int breadTotal = newBread.BreadCost(breadAmount, 0);
      newBread.SetCost(breadTotal);
      
      Console.WriteLine("The total cost of your bread is " + breadTotal + " dollars.");
      Console.WriteLine("Would you like to add any pastries to your order? ['Y' for yes, 'N' for no]");
      ...
      if (secondAnswer == "Y" || secondAnswer == "y")
      {
        ...
        Console.WriteLine("The total cost of your order is " + orderTotal + " dollars.");
